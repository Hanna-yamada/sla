...
class Player(arcade.Sprite):
    ...
    def __init__(self):
        super().__init__("per.png",scale=0.3)
        self.textura_direita = arcade.load_texture("per.png")
        self.textura_esquerda = arcade.load_texture("per2.png")
...
class MeuJogo(arcade.Window):
    def __init__(self):
        ...
        arcade.set_background_color((237, 111, 111))
        self.jogador = Player()
